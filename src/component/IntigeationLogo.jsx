...
function IntigeationLogo() {
  ...
  return (
    <div className="relative z-20 w-screen bg-white h-[80vh] min-h-[80vh] sm:min-h-[100vh] md:min-h-[130vh] lg:min-h-[140vh] flex flex-col items-center justify-center gap-10">
