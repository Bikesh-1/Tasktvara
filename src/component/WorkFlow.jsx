...
function WorkFlow() {
    return (
        <div className="flex relative z-10 flex-col gap-8 justify-center items-center w-screen bg-white
  min-h-[140vh] sm:h-[140vh] lg:min-h-[120vh] xl:min-h-[110vh] 2xl:min-h-[100vh]">
            <ReactLenis root />
