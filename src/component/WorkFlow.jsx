...
function WorkFlow() {
    ...
    return (
        <div className="flex relative z-10 flex-col gap-4 justify-center items-center w-screen min-h-[130vh] bg-white">
            ...
            <div className="flex flex-col-reverse gap-8 justify-around items-center px-2 w-full md:flex-row md:gap-14 md:px-8">
                ...
                <div className="flex justify-center mb-6 w-full md:justify-end md:w-auto md:mb-0">
                    <img
                        className="w-[85vw] xs:w-[22rem] sm:w-[24rem] md:w-[20rem] rounded-3xl object-cover"
